...
form.addEventListener("submit", function (event) {
    ...
    var resumeHTML = "\n    <div class=\"resume-container\">\n        <div class=\"left-section\">\n            ".concat(profilePicture ? "<img id=\"profile-pic\" alt=\"Profile Picture\">" : "", "\n            <h2> ").concat(name, "</h2>\n            <p class=\"profession-cen\">").concat(profession, "</p>\n            <h3 class=\"border\">CONTACT</h3>\n            <p class=\"text-color\">\uD83D\uDCDE&nbsp;&nbsp;").concat(number, "</p>\n            <p class=\"text-color\">\u2709\uFE0F&nbsp;&nbsp;").concat(email, "</p>\n            <p class=\"text-color\">\uD83D\uDCCD&nbsp;&nbsp;").concat(location, "</p>\n            <h3 class=\"border\">ABOUT ME</h3>\n            <p class=\"text-color\">").concat(aboutMe, "</p>\n            <h3 class=\"border\">SKILLS</h3>\n            <p class=\"text-color\">").concat(skills, "</p>\n            <h3 class=\"border\">LANGUAGES</h3>\n            <p class=\"text-color\">").concat(language, "</p>\n        </div>\n        \n        <div class=\"right-section\">\n            <div class=\"section-container\">\n                <h3>EDUCATION</h3>\n                <p>").concat(education, "</p>\n            </div>\n            <div class=\"section-container\">\n                <h3>EXPERIENCE</h3>\n                <p>").concat(experience, "</p>\n            </div>\n            <div class=\"section-container\">\n                <h3>PROJECTS</h3>\n                <p>").concat(project, "</p>\n            </div>\n        </div>\n    </div>");
    if (profilePicture) {
