...
form.addEventListener("submit", (event: Event) => {
    ...
    <div class="resume-container">
        <div class="left-section">
            ...
            <h2> ${name}</h2>
            <p class="profession-cen">${profession}</p>
            <h3 class="border">CONTACT</h3>
            <p class="text-color">📞&nbsp;&nbsp;${number}</p>
            <p class="text-color">✉️&nbsp;&nbsp;${email}</p>
            <p class="text-color">📍&nbsp;&nbsp;${location}</p>
            <h3 class="border">ABOUT ME</h3>
            <p class="text-color">${aboutMe}</p>
            <h3 class="border">SKILLS</h3>
            <p class="text-color">${skills}</p>
            <h3 class="border">LANGUAGES</h3>
            <p class="text-color">${language}</p>
        </div>
